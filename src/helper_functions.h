...
inline double gaussian_2d(double x, double y, double mu_x, double mu_y, double sigma_x, double sigma_y) {

  return 1 / (2 * M_PI * sigma_x * sigma_y) * exp(-0.5 * (pow((x - mu_x) / sigma_x, 2) + pow((y - mu_y) / sigma_y, 2)));
